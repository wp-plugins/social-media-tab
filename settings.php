	...
	if(($key<>'position')AND($key<>'size')AND($key<>'top'))
	 {
	  echo '
	   <tr valign="top">
	    <td colspan=2>
		<img src="'.WP_PLUGIN_URL.'/socialmediatabs/png/classic/'.$key.'.png" style="width:32px;height:32px;vertical-align:middle;"><input type="text" name="'.$key.'" id="'.$key.'" value="'.$value.'" size=40> 
		</td>
	   </tr>
